@section('sideBar')
<aside class="sticky w-80 h-screen top-0 bg-gradient-to-r from-neutral-700 to-neutral-800">
    <div class="text-gray-100 text-xl mb-10">
        <div class="p-2.5 mt-4 flex items-center text-center">
            <h1 class="font-semiboldtext-2xl ml-3 text-neutral-300 italic">Instagram</h1>
        </div>
    </div>
    <div>
    <div class="side-items space-y-2">
    <div class="p-2.5  flex items-center rounded-md px-4 duration-300 cursor-pointer
    hover:bg-yellow-500 hover:text-white text-neutral-300">
    ...
    hover:bg-yellow-500 text-white placeholder-white hover:text-white text-white bg-neutral-600 border-none outline-none">
    ...
    hover:bg-yellow-500 hover:text-white text-white focus:z-10 focus:ring-2 focus:ring-yellow-500 focus:bg-yellow-500 focus:text-white" id="dropdownDefaultButton" data-dropdown-toggle="dropdown" class="text-white bg-blue-700">
