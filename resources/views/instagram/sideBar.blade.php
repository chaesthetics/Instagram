   ...
   <div id="dropdown" class="hidden bg-neutral-800 divide-y-6 drop-shadow-xl rounded-xl shadow w-[280px] ">
    ...
    <div class=" w-full div-y-2 pt-2 pb-2 text-white ">
        <ul>
            ...
            <hr class="mt-2 mb-2">
            <li class="">
                <a href="{{ url('/signin') }}" class="font-semibold text-sm space-x-3 block px-4 py-2 pt-5 pb-5 duration-300 cursor-pointer hover:bg-yellow-600 items-center dark:hover:bg-gray-600 dark:hover:text-white w-11/12 ml-auto mr-auto rounded-md flex">Log out</a>
            </li>
        </ul>
    </div>
</div>
