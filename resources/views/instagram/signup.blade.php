    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 h-screen w-full items-center">
        ...
        <div class="absolute right-5 top-3">
            <div id="toast-warning" class="flex items-center w-full max-w-xs p-4 text-gray-500 bg-white rounded-lg shadow dark:text-gray-400 dark:bg-gray-800" role="alert">
                ...
                <div class="ml-3 text-sm font-normal text-red-700">Registration failed </div>
        ...
        @endif
            <div class="card max-w-[500px] w-full h-full max-auto mr-auto ml-auto">     
                ...
                <div class="mb-6 mt-10">
                    ...
                    <input type="text" id="username" value="{{ old('username') }}" name="username" class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-yellow-500 focus:border-yellow-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-yellow-500 dark:focus:border-yellow-500 dark:shadow-sm-light" 
                ...
                <div class="mb-6">
                    ...
                    <input type="text" id="fullname" name="fullname" value="{{ old('fullname') }}" class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-yellow-500 focus:border-yellow-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-yellow-500 dark:focus:border-yellow-500 dark:shadow-sm-light" placeholder="Enter your fullname" >
                    @error('fullname')       
                        <div class="alert alert-danger text-red-700 font-semibold text-xs">{{ $message }}</div>    
                    @enderror
                </div>
                <div class="mb-6">
                    ...
                    <input type="password" id="password" name="password" placeholder="6+ Characters, 1 uppercase letter, 1 lowercase letter, number" class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-yellow-500 focus:border-yellow-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-yellow-500 dark:focus:border-yellow-500 dark:shadow-sm-light">
                    @error('password')       
                        <div class="alert alert-danger text-red-700 font-semibold text-xs">{{ $message }}</div>    
                    @enderror
                </div>
                ...
                <div class="flex justify-center">
                    <p class="text-sm">Already have an account ? <a href="{{ url('/login')}}" class="text-yellow-400">Sign in</a></p>
                </div>
            </div> 
        </div>
    </div>
