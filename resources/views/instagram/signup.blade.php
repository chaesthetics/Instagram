...
<body>
    <div class="grid grid-cols-1 sm:grid-cols-2 h-screen w-full">
        ...
        <div class="flex flex-col justify-center">  
            <div class="card max-w-[500px] w-full h-full max-auto mr-auto ml-auto mt-20">     
                ...
                <div class="mb-6 mt-10">
                    ...
                    <input type="email" id="email" class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-yellow-500 focus:border-yellow-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-yellow-500 dark:focus:border-yellow-500 dark:shadow-sm-light" placeholder="aurieljames11@gmail.com" required>
                </div>
                <div class="mb-6">
                ...
                <div class="flex justify-center">
                    <p class="text-sm">Already have an account ? <a href="#" class="text-yellow-400">Sign in</a></p>
                </div>
            </div> 
        </div>
    </div>
