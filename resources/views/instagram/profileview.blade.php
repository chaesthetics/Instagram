        ...
        <div class="card-header flex items-center justify-center justify-between ml-10 mt-8 mr-auto w-9/12">
            ...
            <div class="cardinfo">
                <div class="flex ">
                    ...
                    @endif
                    <a href="#"class="transition duration-150 bg-gray-200 pt-2 pb-2 pr-7 pl-7 hover:bg-gray-300 text-sm ml-5 font-semibold rounded-md">Follow</a>
                    <button class="transition duration-150 bg-gray-200 pt-2 pb-2 pr-7 pl-7 hover:bg-gray-300 text-sm ml-2 font-semibold rounded-md">Message</button>
